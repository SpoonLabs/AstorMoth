...
import fr.inria.astor.approaches.tos.core.evalTos.ops.CompositeMethodXMethodReplacementOp;
import fr.inria.astor.approaches.tos.core.evalTos.ops.ConstReplacementOp;
import fr.inria.astor.approaches.tos.core.evalTos.ops.DynaIngredientOperator;
import fr.inria.astor.approaches.tos.core.evalTos.ops.IOperatorWithTargetElement;
import fr.inria.astor.approaches.tos.core.evalTos.ops.LogicExpOperator;
import fr.inria.astor.approaches.tos.core.evalTos.ops.LogicRedOperator;
import fr.inria.astor.approaches.tos.core.evalTos.ops.MethodXVariableReplacementOp;
import fr.inria.astor.approaches.tos.core.evalTos.ops.OperatorReplacementOp;
import fr.inria.astor.approaches.tos.core.evalTos.ops.SupportOperators;
import fr.inria.astor.approaches.tos.core.evalTos.ops.UnwrapfromIfOp;
import fr.inria.astor.approaches.tos.core.evalTos.ops.UnwrapfromMethodCallOp;
import fr.inria.astor.approaches.tos.core.evalTos.ops.VarReplacementByAnotherVarOp;
import fr.inria.astor.approaches.tos.core.evalTos.ops.VarReplacementByMethodCallOp;
import fr.inria.astor.approaches.tos.core.evalTos.ops.WrapwithIfNullCheck;
import fr.inria.astor.approaches.tos.core.evalTos.ops.WrapwithIfOp;
import fr.inria.astor.approaches.tos.core.evalTos.ops.WrapwithTrySingleStatementOp;
...
//		// ops.add("", new UnwrapfromTryOp());//ignored
	...
	public VariantValidationResult validateInstance(ProgramVariant variant) {
		...
		if (variant instanceof MetaProgramVariant) {
			...
			ConfigurationProperties.setProperty(MetaGenerator.METALL, ids);
